...
{
    public class UserToServiceAuthenticationMessageHandler
        : DelegatingHandler
    {
        private readonly ITokenCreator tokenCreator;
        private readonly TokenCreatorConfiguration tokenCreatorConfiguration;

        public UserToServiceAuthenticationMessageHandler(ITokenCreator tokenCreator, IOptions<TokenCreatorConfiguration> options)
        {
